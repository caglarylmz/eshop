        ...
        <div class="card">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                <tr v-for="category in subs" :key="category.id">
                  ...
                  <td class="table-cell">
                    <router-link :to="{name:'', params:{categoryId:category.id}}">
                      <i class="fa fa-chart-line mr-1"></i>
                      <span>İlanlar</span>
                    </router-link>
                  </td>
...
export default {
  ...
  beforeCreate() {
    ...
    this.$store.dispatch("category/getSubs", this.$route.params.categoryId);
  }
};
</script>
