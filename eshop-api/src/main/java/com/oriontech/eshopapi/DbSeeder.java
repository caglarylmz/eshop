...
import com.oriontech.eshopapi.models.AdvertDetail;
import com.oriontech.eshopapi.models.Category;
import com.oriontech.eshopapi.models.Irk;
...
import com.oriontech.eshopapi.models.Yas;
import com.oriontech.eshopapi.repository.AdvertDetailRepository;
import com.oriontech.eshopapi.repository.AdvertRepository;
import com.oriontech.eshopapi.repository.CategoryRepository;
import com.oriontech.eshopapi.repository.IrkRepository;
import com.oriontech.eshopapi.repository.RoleRepository;
import com.oriontech.eshopapi.repository.TipRepository;
import com.oriontech.eshopapi.repository.UserRepository;
import com.oriontech.eshopapi.repository.YasRepository;

import lombok.Data;

@Data
@Component
@ConditionalOnProperty(name = "eshop.db.recreate", havingValue = "true")
public class DbSeeder implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// USERS
		User admin = new User("Çağlar YILMAZ", "admin", "admin@me.com", encoder.encode("csylmz"));
		admin.setRoles(Collections.singleton(adminRole));
		User user = new User("Umut YILMAZ", "user", "user@me.com", encoder.encode("csylmz"));
